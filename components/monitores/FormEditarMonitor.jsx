...
import { addMonitor, updateMonitor } from "utils/monitores";
import InitialContext from "context/InitialContext";

const FormEditarMonitor = () => {
  const { editar, setMonitores, setEditar } = useContext(InitialContext);
  ...
  const { nombres, apellidos, programa, semestre, cedula, telefono } = editar;
  ...
  const onHandleSubmit = (e) => {
    ...
    //enviar data
    updateMonitor(editar, setMonitores);
    setEditar(false);
  };
...
export default FormEditarMonitor;
